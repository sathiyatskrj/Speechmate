...
void main() {
  group('GamificationService - Level Title Tests', () {
    test('Level 1 returns Novice Explorer', () {
      expect(GamificationService.getLevelTitle(1), 'Novice Explorer');
    });

    test('Level 5 returns Village Voice', () {
      expect(GamificationService.getLevelTitle(5), 'Village Voice');
    });
    ...
    test('Level 0 returns first title', () {
      expect(GamificationService.getLevelTitle(0), 'Novice Explorer');
    });
